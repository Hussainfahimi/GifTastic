$(document).ready(function () {
    ...
    //initial array of famous singers
    var movies = ["Tylore Swift", "Areana Grand", "Michael Jackson", "Jennifer Lopez", "Enrique Iglesias", "Justin Bieber", "Adele", "Selena Gomez", "Lady Gaga"]
    GIFArea = " "

    //function for displaying famous singer data
    ...
    $("#add-movie").on('click', function () {
        ...
        //I am using a form so that the user can hit enter instread of clicking the button
